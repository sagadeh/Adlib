...
function startAnimation() {
  ...
  tl.to("#main", {duration: 0.5, visibility: "visible"})
    ...
    //END FRAME 1
    .from("#logo", {duration: 0.5, x: "-20%", opacity: 0, ease: "power2.out", stagger: 0.2})
    ...
    .from("#productImage1", {duration: 0.5, opacity: 0, ease: "power2.out"})
    .from("#subHeadline2", {duration: 0.5, opacity: 0, y: "20%", ease: "power2.out"},'-=0.25')
    .from("#or-text", {duration: 0.5, opacity: 0, ease: "power2.out"})
    .from("#price", {duration: 0.5, opacity: 0, ease: "power2.out"})
    .from("#cashback", {duration: 0.5, opacity: 0, y: "20%", ease: "power2.out"},'-=0.25')
    .from("#cta-wrapper", {duration: 0.5, opacity: 0, x: "20%", ease: "power2.out"})
    .to("#replay-btn-wrapper", {duration: 0, visibility: "visible"})
