...
var tl;
gsap.set("#headline-wrapper, #subheadline-wrapper, #legal-wrapper, #cta-wrapper", {rotationZ:0.01, force3D:false});
...
function startAnimation() {  
    tl = gsap.timeline({
        onStart: function(){
            ...
            if(Adlib.isEmpty(defaultValues.frame1Subheadline) && Adlib.isEmpty(defaultValues.frame2Subheadline) && Adlib.isEmpty(defaultValues.frame3Subheadline)){
                ...
                gsap.set("#logo-headline-wrapper", {flexGrow: "1"});
            }
    ...
    tl.to("#mainContent", {duration: 0, visibility: "visible"})
      .from("#headline-wrapper, #subheadline-wrapper", {duration: 0.5, y: "5px", opacity: 0, force3D: false},'+=0.5')
      .from("#legal-wrapper", {duration: 0.5, opacity: 0, force3D: false, onComplete: function(){
      ...
      .from("#cta-wrapper", {duration: 0.5, x: "-10%", opacity: 0},'-=0.5')
