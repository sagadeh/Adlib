...
function startAnimation() {  
    ...
    tl.to("#mainContent", {duration: 0, visibility: "visible"})
      ...
      .to("#headline1, #subheadline1", {duration: 0.5, opacity: 0, y:"20px"},'+=2')
      .from("#headline2, #subheadline2", {duration: 0.5, opacity: 0, y:"20px", onComplete: function(){
          //NO HEADLINE 3
          var action = (Adlib.isEmpty(defaultValues.frame3Headline)) ? "end" : "screenshot";
          skipTextAnimation(action);
      }})
      .to("#headline2, #subheadline2", {duration: 0.5, opacity: 0, y:"20px"},'+=2')
      .from("#headline3, #subheadline3", {duration: 0.5, opacity: 0, y:"20px"});
}
