...
function startAnimation() {  
    tl = gsap.timeline({
        onStart: function(){
            ...
            if(Adlib.isEmpty(defaultValues.legal) && Adlib.isEmpty(defaultValues.legal2)) gsap.set("#footer-container", {display: "none"});
    ...
    tl.to("#mainContent", {duration: 0, visibility: "visible"})
      ...
      .from("#footer-container", {duration: 0.5, opacity: 0, force3D: false, onComplete: function(){
