...
gsap.set("#headline-wrapper, #subheadline-wrapper, #subheadline2-wrapper, #footer-container, #cta-wrapper", {rotationZ:0.01, force3D:false});
...
function startAnimation() {  
    tl = gsap.timeline({
        onStart: function(){
            ...
            if(Adlib.isEmpty(defaultValues.frame1Subheadline) && Adlib.isEmpty(defaultValues.frame2Subheadline) && Adlib.isEmpty(defaultValues.frame3Subheadline)){
                //gsap.set("#header-container", {display: "flex", flexFlow: "column nowrap", justifyContent: "space-between"});
                /*gsap.set("#subheadline-wrapper", {display: "none"});*/
                gsap.set("#headline-wrapper", {top: "0px", margin: "0px"});
            }
            if(Adlib.isEmpty(defaultValues.legal) && Adlib.isEmpty(defaultValues.legal2)) {
                gsap.set("#legal, #legal2", {display: "none"});
            }
    ...
    tl.to("#mainContent", {duration: 0, visibility: "visible"})
      ...
      .from("#cta-wrapper", {duration: 0.5, x: "-20%", opacity: 0, force3D: false},'-=0.5')
      .from("#footer-container", {duration: 0.5, opacity: 0, onComplete: function(){
