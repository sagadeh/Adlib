...
function initAnimation() {
     ...
     for (let i = 1;i<splitElems.length;i++) {
          (splitElems[i].innerHTML.match(format)) ? splitElems[i].style.top = '2px' : format;
     }
}
...
function introAnimation() {  
     ...
     tween.to("#game1Image", {top:41,rotate:10,duration: 0.5});
     tween.to("#game1Image", {rotate:0,duration: 8});
     tween.to("#game1Image", {top:133,left:-73,duration: 0.5},"-=7");
     tween.to("#game2Image", {top:67,left:117,rotate:-20,duration: 0.5},"-=7");
     tween.to("#game2Image", {rotate:0,duration: 8},"-=6.5");
     tween.to("#game3Image", {top:306,left:152,rotate:-20,opacity:0.99,duration: 0.5},"-=8");
