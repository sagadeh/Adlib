...
function initAnimation() {
     ...
     for (let i = 1;i<splitElems.length;i++) {
          (splitElems[i].innerHTML.match(format)) ? splitElems[i].style.top = '3px' : format;
     }
}
...
function introAnimation() {  
     ...
     tween.to("#game1Image", {top:55,rotate:10,duration: 0.5});
     tween.to("#game1Image", {rotate:0,duration: 8});
     tween.to("#game1Image", {top:55,left:-40,duration: 0.5},"-=7");
     tween.to("#game2Image", {top:72,left:91,rotate:-20,opacity:0.99,duration: 0.5},"-=6.5");
     tween.to("#game2Image", {rotate:0,duration: 8},"-=6");
     tween.to("#game3Image", {top:79,left:188,rotate:-20,opacity:0.99,duration: 0.5},"-=7.8");
     tween.to("#game3Image", {rotate:0,duration: 8},"-=7.3");
     ...
     tween.to("#offerParent", {opacity:0.99,duration: 1},"-=9");
     tween.to("#rating", {opacity:0.99,duration: 1},"-=9");
