...
let Adlib = {
    ...
    populateElements: function() {
        document.querySelectorAll("body *").forEach(e=>{null!=e.getAttribute("adlib-text")&&(Adlib.isEmpty(defaultValues[e.getAttribute("adlib-text")])||(document.querySelector("#"+e.id).innerHTML=defaultValues[e.getAttribute("adlib-text")])),null!=e.getAttribute("adlib-image")&&(document.querySelector("#"+e.id).src=defaultValues[e.getAttribute("adlib-image")]),null!=e.getAttribute("adlib-video")&&(document.querySelector("#"+e.id).src="tools"==checkEnvironment()?defaultValues[e.getAttribute("adlib-video")]:defaultValues[e.getAttribute("studio-video")].substring(defaultValues[e.getAttribute("studio-video")].indexOf(",")+1,defaultValues[e.getAttribute("studio-video")].length),myVideo=document.querySelector("#"+e.id),Enabler.loadModule(studio.module.ModuleId.VIDEO,function(){studio.video.Reporter.attach("adVideo",myVideo)}),_obj.tabActiveCheck())});
    },
    imgLoader: function() {
