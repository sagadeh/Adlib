...
function introAnimation() {  
     tween = gsap.timeline();
     tween.set(["#bg","#headerFooter","#psLogo"],{opacity:1})
     //Headline Animation
     tween.to("#taglineParent", {opacity:0.99,duration: 1,delay:0.5});
     //Game images Animation
     tween.to("#game1Image", {top:113,rotate:10,duration: 0.5});
     tween.to("#game1Image", {rotate:0,duration: 8});
     tween.to("#game1Image", {top:163,left:-67,duration: 0.5},"-=7");
     tween.to("#game2Image", {top:84,left:1,rotate:-20,duration: 0.5},"-=7");
     tween.to("#game2Image", {rotate:0,duration: 8},"-=6.5");
     tween.to("#game3Image", {top:341,left:49,rotate:-20,opacity:0.99,duration: 0.5},"-=8");
     ...
     tween.to("#offerParent", {opacity:0.99,duration: 1},"-=10");
     tween.to("#rating", {opacity:0.99,duration: 1},"-=10");
     tween.to("#ctaContainer", {opacity:0.99,duration: 1,onComplete:takeScreenshot},"-=10");
}
