...
function initAnimation() {
     ...
     for (let i = 1;i<splitElems.length;i++) {
          (splitElems[i].innerHTML.match(format)) ? splitElems[i].style.top = (getStyle(splitElems[i-1],'top')+2)+"px" : splitElems[i].style.top = getStyle(splitElems[i-1],'top')+"px";
     }
}
...
function introAnimation() {  
     ...
     tween.to("#game1Image", {top:-40,rotate:10,duration: 0.5});
     tween.to("#game1Image", {rotate:0,duration: 8});
     tween.to("#game1Image", {top:-33,left:199,duration: 0.5},"-=7");
     tween.to("#game2Image", {top:-33,left:303,rotate:-20,opacity:0.99,duration: 0.5},"-=6.5");
     tween.to("#game2Image", {rotate:0,duration: 8},"-=6");
     tween.to("#game3Image", {top:-26,left:397,rotate:-20,opacity:0.99,duration: 0.5},"-=8");
     ...
     tween.to("#ctaContainer", {opacity:0.99,duration: 1,onComplete:takeScreenshot},"-=9");
     tween.to("#offerParent", {opacity:0.99,duration: 0.5},"-=9");
     tween.to("#rating", {opacity:0.99,duration: 0.5},"-=9");
}
