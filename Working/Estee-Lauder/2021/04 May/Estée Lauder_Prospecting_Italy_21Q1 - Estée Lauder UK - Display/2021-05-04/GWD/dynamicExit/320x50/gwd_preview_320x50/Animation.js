...
function oneframe(){
    ...
    TweenMax.to(['#text1div','#stamp1'], 1,{opacity:0, ease: Power2.easeOut,delay:2.9, force3D:true});
    TweenMax.to(['#ctabox1'], .75,{opacity:1,y:0,rotation: 0.01, ease: Power2.easeOut,delay:3.8, force3D:true});
...
function twoframe(){
    ...
    TweenMax.to(['#frame2box'], 1,{opacity:1, ease: Power2.easeOut,delay:3, force3D:true});
    ...
    TweenMax.to(['#frame2box','#prod2'], 0.5,{opacity:0, ease: Power2.easeOut,delay:7.2, force3D:true});
    TweenMax.to(['#prod2'], 1,{opacity:1, ease: Power2.easeInOut, delay:7.6, force3D:true});
    TweenMax.to(['#ctabox1'], .75,{opacity:1,y:0,rotation: 0.01, ease: Power2.easeOut,delay:7.9, force3D:true});
}