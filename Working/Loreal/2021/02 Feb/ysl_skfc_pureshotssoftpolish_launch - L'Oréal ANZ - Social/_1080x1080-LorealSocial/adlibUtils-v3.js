...
let Adlib = {
    ...
    loadAd: function() {
        gsap.ticker.fps(30),adlibStart(),takeScreenshot(),setTimeout(function(){_obj.textResize(),initAnimation()},2000);
        //{_obj.textResize(),_obj.templateCSS(defaultValues.cssAttrib),initAnimation()},2000);
    },
    textResize: function() {
