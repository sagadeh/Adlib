...
var defaultValues = {
    ...
    frame1Subheadline2:"WHEN YOU<br> SPEND $100",
...
function populate() {
  ...
  document.querySelector("#ver1-logo").setAttribute("source", defaultValues.logo);
  ...
  document.querySelector("#ver2-logo").setAttribute("source", defaultValues.logo);
