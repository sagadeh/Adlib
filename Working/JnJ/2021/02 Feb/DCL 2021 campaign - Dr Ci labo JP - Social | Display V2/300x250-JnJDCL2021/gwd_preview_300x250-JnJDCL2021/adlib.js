...
function populate() {
  ...
  dynamicText[0].style.cssText = `
    ...
    font-family: Noto Sans JP${(defaultValues.customVariable3)}, sans-serif;
  `;

  dynamicText[1].style.cssText = `
    color: ${defaultValues.fontColor1};
    font-size: ${defaultValues.fontSize1}px;
    font-family: Noto Sans JP${(defaultValues.customVariable1)}, sans-serif;
  `;

  dynamicText[2].style.cssText = `
    color: ${defaultValues.fontColor2};
    font-size: ${defaultValues.fontSize2}px;
    font-family: Noto Sans JP${(defaultValues.customVariable2)}, sans-serif;
  `;
  customTrigger();
}