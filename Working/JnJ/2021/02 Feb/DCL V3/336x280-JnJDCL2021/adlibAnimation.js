...
function initAnim(){
  ...
  if(defaultValues.trigger=="377VC"){
    ...
    document.querySelector("#disclaimer-wrapper").style.width = "315px";
  ...
  if(defaultValues.trigger=="AQUAINDERM"){
    ...
    //headline-container
    document.querySelector("#headline-container").style.top = "70px";
    ...
    //frame1Image-wrapper
    document.querySelector("#frame1Image-wrapper").style.paddingTop = "8px";
    ...
    document.querySelector("#disclaimer-wrapper").style.width = "173px";
  ...
  if(defaultValues.trigger=="VC100"){
    ...
    document.querySelector("#disclaimer-wrapper").style.left = "229px";
    document.querySelector("#disclaimer-wrapper").style.width = "105px";
    document.querySelector("#disclaimer-wrapper").style.height = "38px";
