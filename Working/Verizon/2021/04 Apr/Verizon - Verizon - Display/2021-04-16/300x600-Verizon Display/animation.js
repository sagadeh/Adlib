...
//shaking fixed
gsap.set("#headline1", {scale: 0.9, rotationZ:0.50, force3D:false});
gsap.set("#headline2", {scale: 0.9, rotationZ:0.50, force3D:false});
gsap.set("#headline3", {scale: 0.9, rotationZ:0.50, force3D:false});


// gsap.set("#frame1-container", {opacity: 0});
// gsap.set("#frame2-container", {opacity: 0});
// gsap.set("#frame3-container", {opacity: 0});
// gsap.set("#frame4-container", {opacity: 0});
// gsap.set("#frame5-container", {opacity: 0});
// gsap.set("#check-only-wrapper", {opacity: 0});
// gsap.set("#logo3", {opacity: 0});
...
function startAnimation() { 
    ...
    tl.to("#mainContent", {duration: 0.5, visibility: "visible"})
      .to("#headline1", {duration: 2, scale: 1, rotationZ:0.01})
      .to("#logo3", {duration: 0.5, opacity: 0},'-=0.5')
      .to("#headline2", {duration: 2, scale: 1, rotationZ:0.01})
      .from("#check1-only-holder", {duration: 0.25, height: "0%"},'-=1.5')
      .from("#check2-only-holder", {duration: 0.25, width: "0%"},'-=1.3')
      .to("#headline3", {duration: 2.5, scale: 1.3, rotationZ:0.01})
      ...
      .to("#frame4background", {duration: 0.5, scale: 1.05, ease: "power2.out"},"+=0.5")
      .to("#frame4background", {duration: 0.5, scale: 0, ease: "power2.out"})
      .to("#iphonelogo", {duration: 0.5, opacity: 0},"-=0.5")
      .to("#check-only-wrapper", {duration: 0.5, opacity: 0},'-=0.5')
      .from("#subheadline5", {duration: 0.25, y: "100%", force3D: false},"+=0.0")
...
function setHeadlineText2(){
  for(var i = 0; i < parent2.children.length; i++) {
    ...
    gsap.to(parent2.children[i], {duration: 0.5, y: "0%", delay: 2.5, force3D: false});
    gsap.to(parent2.children[i], {duration: 0.5, y: "-100%", delay:4.5, force3D: false});
  }
}
function setHeadlineText3() {
  for(var i = 0; i < parent3.children.length; i++) {
    gsap.set(parent3.children[i], {y: "100%"});
    gsap.to(parent3.children[i], {duration: 0.5, y: "0%", delay: 5, force3D: false});
    //gsap.to("#headline3", {duration: 0.3, scale: "1.3", delay:6.5, ease: "power4.out", force3D: false});
    gsap.to("#headline3", {duration: 0.3, scale: "0", delay:7, ease: "power4.in", force3D: false});
  }
}
