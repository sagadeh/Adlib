...
function startAnimation() {  
    ...
    tl.to("#mainContent", {duration: 0.5, visibility: "visible"})
      .from("#logo", {opacity: 0})
      .from("#headline-wrapper, #frame1-subheadline, #frame1-subheadline2", {opacity: 0, y: "10px", stagger: 0.25, onComplete: takeScreenshot})
      .to("#frame1-headline", {opacity: 0},'+=2')
      .from("#frame2-headline", {opacity: 0, onComplete: takeScreenshot})
      .to("#frame2-headline", {opacity: 0},'+=2')
      .from("#frame3-headline", {opacity: 0})
      .to(["#frame3-headline, #frame1-subheadline, #frame1-subheadline2"], {opacity: 0},'+=2')
      .from("#cta-container, #footer-container", {opacity: 0})
      .from("#arrow", {duration: 0.3, x: "-30%", yoyo: true, repeat: 1, onComplete: takeScreenshot});
}
