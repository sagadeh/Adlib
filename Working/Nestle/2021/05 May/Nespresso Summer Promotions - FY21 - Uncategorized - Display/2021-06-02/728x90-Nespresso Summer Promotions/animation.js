...
function startAnimation() {  
    ...
    tl.to("#mainContent", {duration: 0.5, visibility: "visible"})
      .from("#logo", {opacity: 0})
      .from("#frame1-wrapper, #frame1-subheadline, #cta-container", {opacity: 0, y: "10px", stagger: 0.25, onComplete: takeScreenshot})
      .to("#frame1-wrapper, #frame1-subheadline", {opacity: 0},'+=2')
