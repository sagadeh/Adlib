...
function startAnimation() {  
    ...
    tl.to("#mainContent", {duration: 0.5, visibility: "visible"})
      .from("#logo", {opacity: 0})
      .from("#headline-wrapper, #frame1-subheadline, #frame1-subheadline2", {opacity: 0, y: "20px", stagger: 0.25})
      .from("#cta-container, #footer-container", {opacity: 0, onComplete: takeScreenshot})
