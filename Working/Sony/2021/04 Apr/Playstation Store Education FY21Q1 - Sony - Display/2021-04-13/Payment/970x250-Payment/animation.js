...
function startAnimation() {  
    ...
    tl.set(["#char_holder"], {  scale:1.05, x:355, y:-103, transformOrigin:tf_origin, rotation:.001 , force3D:true});

    tl.set(["#bg_img"], { scale:0.95, x:-409, y:98, transformOrigin:tf_origin, rotation:.001 , force3D:true});
