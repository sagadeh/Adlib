...
function startAnimation() {  
     ...
     tl.set(["#char_holder"], { scale:.8, x:-60, transformOrigin:tf_origin, rotation:.001 , force3D:true});
 
     tl.set(["#bg_img"], { scale:.7, x:-145, y:-110, transformOrigin:tf_origin, rotation:.001 , force3D:true});
    ...
    // First Move of characters
     ...
     tl.to(["#grad"], .75, { y:0, ease: Power1.easeOut}, 3);
     ...
     tl.to(["#char_holder"], .5, { scale: .9, y:-20, ease: Power1.easeOut }, "+="+0);
 
     //tl.to(["#ui"], .5, { y:"+=15", ease: Power1.easeOut },"<1");
 
     tl.to(["#blue_bg"], .75, { y:0, ease: Power1.easeOut}, "-="+.25);
