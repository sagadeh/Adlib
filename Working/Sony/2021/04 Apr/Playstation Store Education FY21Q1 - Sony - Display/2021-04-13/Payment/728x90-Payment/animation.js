...
function startAnimation() {  
    ...
    tl.set(["#char_holder"], {  scale:.6, x:275, y:-200, transformOrigin:tf_origin, rotation:.001 , force3D:true});
    ...
    tl.set(["#char5b"], { scale:.2, x:-195, y:-70, transformOrigin:tf_origin, force3D:true, rotation:.001, autoAlpha: 1 }, "+=0");

    tl.set(["#ui" ], { scaleY:.2, scaleX:.4, x:-122, y:-115, transformOrigin:tf_origin, force3D:true, rotation:.001 }, "+=0");

    tl.set(["#uia" ], { scaleY:.4, scaleX:.8, x:-62, y:6, transformOrigin:tf_origin, force3D:true, rotation:.001 }, "+=0");
   ...
   // First Move of characters
    ...
    tl.to(["#char1"], .75, { scale:.2, x:"-=100", y:"+=10", ease: Power1.easeOut}, .5);

    tl.to(["#char2"], .75, { scale:.25, x:"-=95", y:"+=30", ease: Power1.easeOut}, .5);

    tl.to(["#char3"], .75, { scale:.38, x:"-=145", y:"-=30", ease: Power1.easeOut}, .5);

    tl.to(["#char4"], .75, { scale:.25, x:"-=110", y:"-=15", ease: Power1.easeOut}, .5);

    tl.to(["#char5"], .75, { x:"-=130",y:"+=5", autoAlpha: 1, ease: Power1.easeOut}, .5);

    tl.to(["#char5b"], .75, { x:"-=100", y:"-=10", autoAlpha: 0, ease: Power1.easeOut}, .5);
    ...
    tl.to(["#char1b"], 1, { x:"-=110",y:"+=5",autoAlpha: 1, ease: Power1.easeOut}, 2.25);

    tl.to(["#char2"], 1, { scale:.2, x:"-=85", y:"+=15", ease: Power1.easeOut}, 2.25);

    tl.to(["#char3"], 1, { scale:.25, x:"-=65", y:"+=30", ease: Power1.easeOut}, 2.25);

    tl.to(["#char4"], 1, { scale:.38, x:"-=110", y:"-=30", ease: Power1.easeOut}, 2.25);

    tl.to(["#char5"], 1, { scale:.25, x:"-=50", y:"-=15", ease: Power1.easeOut}, 2.25);
    ...
    tl.to(["#char_holder"], .5, { scale: .9, x: 135, y:"+=43", ease: Power1.easeOut }, "+="+0);

    tl.to(["#char1", "#char1b", "#char2", "#char3", "#char5","#char5b",], { y:"-=20", ease: Power1.easeOut }, 6.5);

    tl.to(["#blue_bg"], .75, { x:0, ease: Power1.easeOut}, "-="+.25);

    tl.to(["#t2"], .5, { autoAlpha: 1, y:0, ease: Power1.easeOut ,onComplete:takeScreenshot}, "+="+.25);

    tl.to(["#t3"], .5, { autoAlpha: 1, y:0, ease: Power1.easeOut ,onComplete:takeScreenshot}, "+="+1);
