...
function startAnimation() {  
     ...
     tl.set(["#buildings", "#clouds", "#people", "#phone"], { left:'50%', top:'-15%', xPercent:'-50', yPercent:'-50', transformOrigin:"50% 60%", rotation: .001, force3D:true});
 
     tl.set(["#phone"], { scale:.3, autoAlpha:0, transformOrigin:"50% 80%", force3D:true, rotation: .001 }, "+=0");
     ...
     tl.to(["#buildings", "#clouds", "#people", "#phone", "#figure"], .75, { x:-120, ease: Power3.easeOut}, 2);
