...
function startAnimation() {  
     ...
     tl.set(["#buildings", "#clouds", "#people", "#phone"], { left:'50%', top:'42%', xPercent:'-50', yPercent:'-50', transformOrigin:"50% 36%", rotation: .001, force3D:true});
 
     tl.set(["#phone"], { scale:.3, autoAlpha:0, transformOrigin:"50% 70%", force3D:true, rotation: .001 }, "+=0");
 
     tl.set(["#figure"], { scale:.75, y:170, force3D:true, rotation: .001, left:'50%', top:'50%', xPercent:'-50', yPercent:'-50',}, "+=0");
