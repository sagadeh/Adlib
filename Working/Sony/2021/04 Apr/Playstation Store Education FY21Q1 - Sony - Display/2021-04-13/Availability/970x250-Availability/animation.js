...
function startAnimation() {  
     ...
     tl.set(["#buildings", "#clouds", "#people", "#phone"], { left:'50%', top:'-5%', xPercent:'-50', yPercent:'-50', transformOrigin:"50% 60%", rotation: .001, force3D:true});
 
     tl.set(["#phone"], { scale:.3, autoAlpha:0, transformOrigin:"50% 80%",top:'-10%', force3D:true, rotation: .001 }, "+=0");
     ...
     tl.to(["#figure"], 3, { scale:1, y:0, ease: Power3.easeOut}, 0);
     ...
     tl.to(["#buildings", "#clouds", "#people", "#phone", "#figure"], .75, { x:-150, ease: Power3.easeOut}, 2);
     ...
     tl.to(["#blue_bg"], .75, { x:0, ease: Power1.easeOut}, "+="+2.5);
