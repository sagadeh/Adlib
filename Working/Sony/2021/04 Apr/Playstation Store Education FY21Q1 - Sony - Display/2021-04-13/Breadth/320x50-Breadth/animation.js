...
function startAnimation() {  
    ...
    tl.set(["#bg_img"], { scale:3, left:'78%', top:'12%', xPercent:'-50', yPercent:'-50', transformOrigin:"22% 88%", rotation:.001 , force3D:true});

    tl.set(["#figure"], { scale:1.4, x:330, y:45, xPercent:'-50', yPercent:'-50', transformOrigin:"50% 50%",  force3D:true, rotation:.001 }, "+=0");




    tl.set(["#t1", "#t2", "#t3"], { y: 10, force3D:true, rotation: .001 }, "+=0")
    ...
    tl.to(["#figure"], 4, { scale:.5, x:160, y:25,  ease: Power3.easeOut}, 0);
    ...
    tl.to(["#t2"], .5, { autoAlpha: 1, y:0, ease: Power1.easeOut ,onComplete:animationEnd}, 5.4);
}
