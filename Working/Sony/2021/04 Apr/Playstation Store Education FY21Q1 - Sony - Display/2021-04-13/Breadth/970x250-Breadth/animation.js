...
function startAnimation() {  
    ...
    tl.set(["#bg_img"], { scale:3, left:'77%', top:'21%', xPercent:'-50', yPercent:'-50', transformOrigin:"23% 79%", rotation:.001 , force3D:true});

    tl.set(["#figure"], { scale:1.4, x:985, y:225, xPercent:'-50', yPercent:'-50', transformOrigin:"50% 50%",  force3D:true, rotation:.001 }, "+=0");
    ...
    tl.to(["#figure"], 4, { scale:.5, x:480, y:128,  ease: Power3.easeOut}, 0);
