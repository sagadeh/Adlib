...
function startAnimation() {  
    ...
    tl.set(["#figure"], { scale:1.4, x:300, y:45, xPercent:'-50', yPercent:'-50', transformOrigin:"50% 50%",  force3D:true, rotation:.001 }, "+=0");
    ...
    tl.to(["#figure"], 4, { scale:.5, x:150, y:25,  ease: Power3.easeOut}, 0);
