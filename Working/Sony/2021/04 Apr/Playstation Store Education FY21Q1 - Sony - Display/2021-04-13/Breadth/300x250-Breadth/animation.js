...
function startAnimation() {  
    ...
    tl.set(["#bg_img"], { scale:3, left:'77%', top:'32%', xPercent:'-50', yPercent:'-50', transformOrigin:"23% 68%", rotation:.001 , force3D:true});

    tl.set(["#figure"], { scale:1.4, x:255, y:200, xPercent:'-50', yPercent:'-50', transformOrigin:"50% 50%",  force3D:true, rotation:.001 }, "+=0");
    ...
    tl.to(["#figure"], 4, { scale:.5, x:150, y:125,  ease: Power3.easeOut}, 0);
