...
function startAnimation() {  
    ...
    tl.set(["#bg_img"], { scale:3, left:'72%', top:'47%', xPercent:'-50', yPercent:'-50', transformOrigin:"28% 53%", rotation:.001 , force3D:true});

    tl.set(["#figure"], { scale:1.4, x:120, y:480, xPercent:'-50', yPercent:'-50', transformOrigin:"50% 50%",  force3D:true, rotation:.001 }, "+=0");

 


    tl.set(["#cta", "#t1", "#t2", "#t3"], { y: 10, alpha:0, force3D:true, rotation: .001 }, "+=0")
    ...
    tl.to(["#figure"], 4, { scale:.5, x:80, y:300,  ease: Power3.easeOut}, 0);

    tl.to(["#grad"], 1.5, { y:0, ease: Power1.easeOut}, 0);

    tl.to(["#t1"], .5, { autoAlpha: 1, y:0, ease: Power1.easeOut ,onComplete:takeScreenshot}, 2.4);

    tl.to(["#blue_bg"], .75, { y:0, ease: Power1.easeOut}, 4.4);
