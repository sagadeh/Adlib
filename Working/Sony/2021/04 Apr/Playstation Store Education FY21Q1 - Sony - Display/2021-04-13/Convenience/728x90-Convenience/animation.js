...
function startAnimation() {  
    ...
    tl.set(["#bg_img", "#room", "#figure", "#laser"], { scale:1, left:'50%', top:'50%', xPercent:'-50', yPercent:'-45', transformOrigin:"50% 50%", force3D:true, rotation: .001 }, "+=0");

    tl.set(["#bg_img"], { xPercent:'-50', yPercent:'-50'}, "+=0");

    tl.set(["#room"], { scale: .2, x:-300, y:-50, rotation: -40, transformOrigin:"0% 50%"});

    tl.set(["#laser"], { x:-420, y:-200, transformOrigin:"0% 50%"});

    tl.set(["#figure"], { x:-450, y:-100, transformOrigin:"0% 50%"}, "+=0");
    ...
    tl.to(["#blue_bg"], .75, { x:0, ease: Power1.easeOut}, 9);
