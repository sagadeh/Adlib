...
var defaultValues = { 
  ...
  frame3Headline:"Starts low and stays low",
  ...
  readableLabel:" ",  
  animationType:"Aspirational", //Aspirational,Rates,Cashback
...
function ChartShowCashBack() {
  ...
  //ADDITIONAL FRAME
  gsap.to("#frame3Headline_v2", {duration: 0.5, ease: "imageEaseOut", opacity: 1, delay: 6.5});
  gsap.to("#frame3Subheadline_v2", {duration: 0.5, ease: "imageEaseOut", opacity: 1, delay: 6.5});
  gsap.to("#frame3Headline_v2", {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9});
  gsap.to("#frame3Subheadline_v2", {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9});
  
  gsap.to(frame2Image, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9});
  gsap.to(frame1Image, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9});
  gsap.to(Logo, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9});
  gsap.to(gradient, {duration: 0.5, ease: "imageEaseOut",opacity: 0, delay: 9});
  gsap.to(Hex, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9});
  
  gsap.to(frame3, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 9,onComplete: function(){
    callAdlibScreenshot();
