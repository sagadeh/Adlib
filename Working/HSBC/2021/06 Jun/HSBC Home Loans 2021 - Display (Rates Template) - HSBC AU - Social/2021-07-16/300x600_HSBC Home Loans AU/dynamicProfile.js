...
function populate(){
  ...
  document.querySelector("#subheadline3-cashback").innerHTML = defaultValues.frame4Subheadline3;
...
function initializeAnimation () {
  ...
  //gsap.set(whiteBackground, {opacity: 0});
  animationCall();
...
function animationCall () {
  ...
  if (defaultValues.animationType == "Rates") {
   ...
   ///// Original animation 243px
   gsap.set(headlineWrap,{top:243});
   gsap.set(frame3, {top: -130});
...
function lastFrameAnimation() {
  if(defaultValues.animationType == "Aspirational") {
    ...
    gsap.to(LineRed, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.5});
