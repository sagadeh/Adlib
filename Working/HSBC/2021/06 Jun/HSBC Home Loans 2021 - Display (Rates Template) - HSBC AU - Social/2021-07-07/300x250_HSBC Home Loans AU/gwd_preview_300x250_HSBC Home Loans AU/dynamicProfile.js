...
var defaultValues = { 
  ...
  frame1Headline:"Lorem<br>ipsum",
  frame2Headline:"Lorem<br>ipsum",
  frame3Headline:"n/a",
  ...
  legal:"^Comparison rate warning, T&C's, and lending criteria applies. Issued by<br>HSBC Bank Australia Limited. Australian Credit Licence/AFSL 232595.",
  readableLabel:" ",
  animationType:"Cashback",
...
var frame4Headline2 = document.getElementById("frame3Headline2");
var frame4Headline3 = document.getElementById("frame3Headline3");
...
/*function typeofAnimation(){
    animationRenderCurrent = defaultValues.animationType === "Aspirational" ? false : true;
...
function twoDecimal() {
  ...
  frame4Headline2.innerHTML = defaultValues.frame4Headline2;
  frame4Headline2.innerHTML = defaultValues.frame4Headline3;
}
...
function frame3ShowRates(){
  gsap.to(frame3Headline, {duration: 0.4, ease: "imageEaseIn", opacity: 1, delay: 0});
  gsap.to(frame3Headline2, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1});
  gsap.to(percenConstantB, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.3})
  gsap.to(frame3Subheadline, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1});
  gsap.to(Line_1, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.2});
  gsap.to(frame3Headline3, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.3});
  gsap.to(percenConstantA, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1})
  gsap.to(frame3Subheadline2, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.3});
}
function frame3ShowCashBack(){
  //gsap.to(frame3Headline, {duration: 0.4, ease: "imageEaseIn", opacity: 1, delay: 0});
  gsap.to(frame3Headline2, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1});
  gsap.to(percenConstantB, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.3})
  gsap.to(frame3Subheadline, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1});
...
function animationCall () {
  //console.log("animation Call Two");
 if (defaultValues.animationType == "Rates") {
   console.log("Rates")
   gsap.set(headlineWrap,{top:19});
   gsap.set(subheadlineWrap,{top:98});
   ...
   gsap.to(frame3, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 0, onComplete: function(){
     callAdlibScreenshot();
     frame3ShowRates();
   }});
  ...
  ///// Original animation call 
  console.log("Aspirational")
  gsap.set(subheadlineWrap,{top:110});
  gsap.set(headlineWrap,{top:79});
  gsap.set(frame3, {top: -2, left:2});
  gsap.set(frame3Headline, {top: 29});
  ...
  //console.log("animation Call One");
  gsap.to(frame1Image, { scale:1, ease: "imageEaseIn", duration: 3, delay:0});
  gsap.to(Logo, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 0});
  gsap.to(gradient, {duration: 0.5, ease: "imageEaseIn",opacity: 1, delay: 0});
...
function lastFrameAnimation() {
  if(defaultValues.animationType == "Aspirational") {
    ...
    gsap.to(HexOriginal, {duration: 0.5, ease: "v", opacity: 0, delay: 0});
    ...
    gsap.to(LineRed, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 10.5});
  ...
  if(defaultValues.animationType == "Cashback") {
    ...
    gsap.to(Logo, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 0});
    gsap.to(gradient, {duration: 0.5, ease: "imageEaseOut",opacity: 0, delay: 0});
    gsap.to(HexOriginal, {duration: 0.5, ease: "v", opacity: 0, delay: 0, onComplete: function() {
      cashBackAnimation();
    }});
  }
  if(defaultValues.animationType == "Rates") {
    ...
    gsap.to(Logo, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 0});
    gsap.to(gradient, {duration: 0.5, ease: "imageEaseOut",opacity: 0, delay: 0});
    gsap.to(Hex, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 0});
    gsap.to(frame3, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 0, onComplete: function(){
      callAdlibScreenshot();
      gsap.set(frame3, {top: -2, left:2});
      gsap.set(frame3Headline, {top: 29});
      frame3.style.color = "black";
    ...
    gsap.to(legal, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 1.5});
    gsap.to(ctaText, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 2.8, onComplete: function(){
      gsap.delayedCall(2, adlibEnd);
    }});
  }
}
...
function detectBrowser(){
  ...
  if (navigator.platform.indexOf('Win') > -1) { //windows 
    ...
    if (false || !!document.documentMode) {
      ...
      //ctaText.style.fontSize ="30px";
      console.log("ctaLetterspacing---->");
