...
var defaultValues = { 
  ...
  frame3Headline2:"2.59",
  frame3Headline3:"2.60",
...
function animationCall () {
 ...
 if (defaultValues.animationType == "Rates") {
  ...
  // third frame
  gsap.to(frame3, {duration: 1, ease: "imageEaseIn", opacity: 1, delay: 6.5});
  ...
  gsap.to(Line_1, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 7.5});
  ...
  gsap.to(ctaText, {duration: 0.5, ease: "imageEaseIn", opacity: 1, delay: 8.8, onComplete: function(){
  ...
  gsap.to(Logo, {duration: 0.5, ease: "imageEaseOut", opacity: 0, delay: 6});
  gsap.to(gradient, {duration: 0.5, ease: "imageEaseOut",opacity: 0, delay: 6});
  gsap.to(HexOriginal, {duration: 0.5, ease: "v", opacity: 0, delay: 6, onComplete: function() {
    cashBackAnimation();
  }});
 }
} 
