 ...
 if(animationtype == "1"){
    ...
    function anim2(){
     ...
     function anim3(){
      ...
      gsap.to(['#frame4headline'],{ opacity:1, duration:.8, delay:1.2});
      gsap.to(['#badgeimage'],   { opacity:1, duration:.8, delay:1.2});

      gsap.to(['#ctaWrapper'],           { opacity:1, duration:.4, delay:3.25});
      gsap.to(['#frame4subheadline'],  { opacity:1, duration:.4, delay:3.25});
      gsap.to(['#logoimage2'],         { opacity:1, duration:.4, delay:3.25});
      gsap.to(['#frame1subheadline2'],  {css:{color:"#000000", opacity:1}, duration:.4, delay:3.25,
       onComplete: function(){
				callAdlibScreenshot();
