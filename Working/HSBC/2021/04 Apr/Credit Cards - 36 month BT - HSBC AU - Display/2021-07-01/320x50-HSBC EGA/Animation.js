...
function populate(){
  ...
  frame1subheadline2.innerHTML = defaultValues.frame1Subheadline2; //tagline
...
function animateNow(animationtype){
  ...
  if(animationtype == "1"){
    ...
    function anim3(){
      ...
      gsap.to(['#frame4headline'],{ opacity:1, duration:.8, delay:0.5});
      gsap.to(['#ctaWrapper'],           { opacity:1, duration:.8, delay:0.5});
      gsap.to(['#frame4subheadline'],  { opacity:1, duration:.8, delay:0.5});
      gsap.to(['#logoimage2'],         { opacity:1, duration:.8, delay:0.5});
      //gsap.to(['#frame1subheadline'],  {css:{color:"#000000", opacity:1}, duration:.4, delay:2,});
      gsap.to(['#badgeimage'],   { opacity:1, duration:.8, delay:0.5,  onComplete: function(){
        callAdlibScreenshot();
