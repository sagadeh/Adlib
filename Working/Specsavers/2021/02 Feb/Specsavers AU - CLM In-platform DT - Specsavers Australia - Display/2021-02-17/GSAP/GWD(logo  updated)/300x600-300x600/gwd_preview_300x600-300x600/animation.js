...
if(defaultValues.animationType = "A"){
  ...
  //ctaBounce
      .to(ctatext, .1, { ease: "inAnimation", y: -4, force3D: true, delay: 3.8 }) 
      .to(ctatext, .1, { ease: "outAnimation", y: 0, force3D: true }) 
      .to(ctatext, .1, { ease: "inAnimation", y: -2, force3D: true }) 
      .to(ctatext, .1, { ease: "outAnimation", y: 0, force3D: true, onComplete:  callAdlibScreenshot})
  ...
  //fadeout
      .to([headline1], 1, { ease: "outAnimation", x: -100, opacity: 0, delay: 1, force3D: true }) 
  ...
  //setAnimation
      .to(curveImg, 0, { y: 300, rotatiotin: 0.01, force3D: true })
  ...
  //fadein
      ...
      .to(legaltext, 1, { ease: "inAnimation", opacity: 1, rotation: 0.01, force3D: true, delay: -0.5, onComplete: callAdlibScreenshot})
  //ctaBounce
      .to(ctatext, .1, { ease: "inAnimation", y: -4, force3D: true, delay: 1.8 }) 
      .to(ctatext, .1, { ease: "outAnimation", y: 0, force3D: true }) 
      .to(ctatext, .1, { ease: "inAnimation", y: -2, force3D: true }) 
