...
var studioPlatform = () => {
    ...
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].Reporting_Label = "60051d7c30a8c000065a890b-600521e730a8c000065a899e_30";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].Variant_name = "A";
    ...
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame1Image.Url = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame2Image = {};
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame2Image.Url = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame1Headline = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame1Subheadline = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame2Headline = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].frame2Subheadline = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].ctaText = " ";
    ...
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].baseImage.Url = " ";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].customVariable = "&nbsp;";
    devDynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].customVariable2 = "100";
    ...
    defaultValues.customVariable2 = dynamicContent.Specsavers_AU__BAA_InPlatform_DT_AdLib_Feed[0].customVariable2;
}
