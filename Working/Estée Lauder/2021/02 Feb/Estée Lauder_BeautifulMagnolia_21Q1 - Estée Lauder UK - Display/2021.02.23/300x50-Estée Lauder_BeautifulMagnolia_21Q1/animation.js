...
function startAnimation() {  
    ...
    tl.to("#mainContent", {duration: 0, opacity: 1})
      .to("#frame1Headline", {duration: 0.5, opacity: 0, force3D: false},'+=2.5')
      .from("#frame1Subheadline", {duration: 0.5, opacity: 0, force3D: false})
      .to("#frame1Subheadline", {duration: 0.5, opacity: 0, force3D: false},'+=2.5')
      .from("#frame1Headline2", {duration: 0.5, opacity: 0, force3D: false});    
}
function scaleAnim() {
    var tl = gsap.timeline();
    tl.from("#frame1Background", {duration: 5, scale: 1.1, force3D: false, onComplete: takeScreenshot})
