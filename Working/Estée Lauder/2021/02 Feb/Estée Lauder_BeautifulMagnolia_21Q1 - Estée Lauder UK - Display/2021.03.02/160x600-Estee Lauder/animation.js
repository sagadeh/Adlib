...
function initAnimation() {
     gsap.set("#flare", {opacity:0, x:0, y:20});
     startAnimation();
}
...
gsap.to("#flare", {duration: 3, x:20, y:-60, opacity:1, force3D: false});
gsap.to("#flare", {duration: 2, opacity:0, delay:2.5, force3D: false, onComplete: function(){ gsap.set("#flare", {opacity:0, x:0, y:20});}});
gsap.to("#flare", {duration: 3, x:20, y:-60, delay:5, opacity:1, force3D: false});
